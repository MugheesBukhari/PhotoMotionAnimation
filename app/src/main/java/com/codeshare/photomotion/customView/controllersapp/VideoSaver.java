...
import com.codeshare.photomotion.customView.FFMPEGSaver;
...
public class VideoSaver extends AsyncTask<Object, Integer, String> {
    ...
    private String saveToInternalStorage(String text) {
        File file = new File(new ContextWrapper(context).getDir("localStore", 0), "video.txt");
    ...
    public String doInBackground(Object... objArr) {
        ...
        while (i2 < totalFrames) {
            ...
            File file = new File(new ContextWrapper(context).getDir("localStore", 0), fname);
        ...
        File file = new File(new ContextWrapper(context).getDir("localStore", 0), videoFileName);
